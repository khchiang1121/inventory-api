# Generated by Django 5.2.6 on 2025-09-22 07:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Available rack identifier", max_length=32, unique=True
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("name", models.CharField(help_text="Fab identifier", max_length=32, unique=True)),
                (
                    "external_system_id",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("vendor", models.CharField(default="NVIDIA", max_length=64)),
                ("architecture", models.CharField(blank=True, max_length=64)),
                ("description", models.TextField(blank=True)),
                ("memory", models.IntegerField(help_text="GPU memory in MB")),
                ("memory_bandwidth", models.IntegerField(blank=True, help_text="GB/s", null=True)),
                ("compute_capability", models.CharField(blank=True, max_length=16)),
                ("power_consumption", models.IntegerField(blank=True, help_text="W", null=True)),
                ("driver_version", models.CharField(blank=True, max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ManyToManyField(
                        related_name="baremetal_groups", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "user_group",
                    models.ManyToManyField(related_name="baremetal_groups", to="auth.group"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="baremetal_model_gpus",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Indicates the max number of racks to spread the scheduling strategy",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indicates if the cluster can be deploy in the same dc with it's failure zone cluster",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indicates if the cluster can be deploy in the same phase with it's failure zone cluster",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indicates if the cluster can be deploy in the same region with it's failure zone cluster",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indicates if the cluster can be deploy in the same tenant with it's failure zone cluster",
                    ),
                ),
                (
                    "cluster_shared",
                    models.BooleanField(
                        default=False,
                        help_text="Indicates if the scheduling strategy can be shared by multiple clusters",
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Indicates the number of racks to balance the scheduling strategy",
                    ),
                ),
                (
                    "status",
                ...
                (
                    "available_group",
                    models.ManyToManyField(
                        related_name="scheduling_strategies", to="api.availablegroup"
                    ),
                ),
                (
                    "tenant",
        ...
        migrations.CreateModel(
            name="SchedulingStrategyCondition",
            fields=[
                (
                    "id",
                    models.UUIDField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    models.DecimalField(
                        blank=True, decimal_places=2, help_text="Amount", max_digits=10, null=True
                    ),
                ),
                (
                    "used",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bgp",
                    models.CharField(help_text="BGP that this unit belongs to", max_length=32),
                ),
                (
                    "rack",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ManyToManyField(
                        related_name="owned_baremetals", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "user_group",
                    models.ManyToManyField(related_name="owned_baremetals", to="auth.group"),
                ),
                (
                    "baremetal_group",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_group",
                    models.ManyToManyField(related_name="virtual_machines", to="auth.group"),
                ),
                (
                    "specification",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            name="VirtualMachineSpecificationGPU",
            fields=[
                (
                    "id",
                    models.UUIDField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="api.VirtualMachineSpecificationGPU",
                to="api.physicalgpumodel",
            ),
        ),
        migrations.CreateModel(
