...
from virtflow.api.models import (
    AnsibleGroup, AnsibleGroupVariable, AnsibleGroupRelationship, 
    AnsibleHost, Baremetal, VirtualMachine
)
...
class AnsibleInventoryGenerator:
    ...
    def _get_host_data(self, host: AnsibleHost) -> Dict[str, Any]:
        ...
        if host.ansible_ssh_private_key_file:
            host_data['ansible_ssh_private_key_file'] = host.ansible_ssh_private_key_file
...
class AnsibleGroupManager:
    ...
    @staticmethod
    def create_group(name: str, description: str = "", is_special: bool = False) -> AnsibleGroup:
    ...
    @staticmethod
    def add_group_variable(group: AnsibleGroup, key: str, value, value_type: str = 'string'):
...
if __name__ == "__main__":
    ...
    print("Then import and run: from ansible_utils import example_usage; example_usage()") 